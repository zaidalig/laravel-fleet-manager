<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Login - Fleet Manager</title>
...
<body><main class="auth-page"><div class="auth-panel shadow-sm"><div class="mb-4"><div class="brand-mark mb-3"><i class="fa-solid fa-truck"></i></div><h1 class="h3 fw-bold">Fleet Manager Login</h1><p class="text-muted">Vehicles, drivers, trips, fuel, and maintenance.</p></div>
