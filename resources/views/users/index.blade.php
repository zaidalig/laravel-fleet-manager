...
<div class="col-md-3"><select name="role" class="form-select form-select-sm form-select-compact"><option value="">All Roles</option>@foreach(['owner','manager','driver','viewer'] as $r)<option value="{{ $r }}" @selected(request('role')===$r)>{{ ucfirst($r) }}</option>@endforeach</select></div>
