...
<head>
    ...
    <title>@yield('title', 'Dashboard') - Fleet Manager</title>
...
<aside class="sidebar" id="sidebar">
    <div class="brand"><i class="fa-solid fa-truck"></i><span>Fleet Manager</span></div>
    <ul class="nav-list">
        ...
        @can('manage-fleet')
        <li class="nav-item"><a href="{{ route('vehicles.index') }}" class="nav-link {{ request()->routeIs('vehicles.*')?'active':'' }}"><i class="fa-solid fa-car"></i><span>Vehicles</span></a></li>
...
<div class="main-wrapper">
    ...
    <main class="content-body">
        ...
        <footer class="app-footer"><i class="fa-solid fa-truck me-2"></i>Fleet Manager</footer>
    </div>
