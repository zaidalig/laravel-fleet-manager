...
<div class="mb-3">@if($vehicle->photo_path)<img src="{{ media_url($vehicle->photo_path) }}" alt="{{ $vehicle->plate_number }}" class="rounded" style="width:96px;height:96px;object-fit:cover;">@else<span class="rounded bg-light border d-inline-flex align-items-center justify-content-center" style="width:96px;height:96px;"><i class="fa-solid fa-car text-muted fs-2"></i></span>@endif</div>
