...
@if(isset($vehicle) && $vehicle->photo_path)<div class="col-md-4 d-flex align-items-center"><img src="{{ media_url($vehicle->photo_path) }}" alt="{{ $vehicle->plate_number }}" class="rounded me-2" style="width:48px;height:48px;object-fit:cover;"><span class="text-muted small">Current photo</span></div>@endif
</div>
